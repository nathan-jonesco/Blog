...
export function ThemeSelector(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LightIcon className="hidden h-4 w-4 fill-gray-400 [[data-theme=light]_&]:block" />
        <DarkIcon className="hidden h-4 w-4 fill-gray-400 [[data-theme=dark]_&]:block" />
      ...
      <Listbox.Options className="absolute top-full left-1/2 mt-3 w-36 -trangray-x-1/2 space-y-1 rounded-xl bg-white p-3 text-sm font-medium shadow-md shadow-black/5 ring-1 ring-black/5 dark:bg-gray-800 dark:ring-white/5">
        {themes.map((theme) => (
          <Listbox.Option
            key={theme.value}
            value={theme}
