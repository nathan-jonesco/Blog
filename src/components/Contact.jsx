      ...
      >
        <div className="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-2.5">
              <input
                ...
                className="block w-full rounded-md border-0 py-2 px-3.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div>
          ...
          <div className="sm:col-span-2">
            ...
            <div className="relative mt-2.5">
              ...
              <input
                ...
                id="phone-number"
                autoComplete="tel"
                className="block w-full rounded-md border-0 py-2 px-3.5 pl-20 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 sm:text-sm sm:leading-6"
              />
            </div>
          </div>
          <div className="sm:col-span-2">
          ...
          <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
            ...
            <Switch.Label className="text-sm leading-6 text-gray-600 dark:text-red-200">
